...
def build_prompt(
    ...
    return f"""
You are AuraInsight's strategy consultant. Based on the input JSON, produce a consulting-grade “Trade Area & Growth Diagnostic Report” for a legacy Hong Kong-style restaurant in San Francisco,also prodece a specific deail step by step plan for improvement,the report must be detail and at leaset 6 pages of contents,and use chinese for the report.
